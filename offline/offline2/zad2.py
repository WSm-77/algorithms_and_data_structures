...
#
# Opis:
# Algorytm opiera się na stworzeniu posortowanej tablicy z "p" pierwszymi wartościami wejściowej tablicy. Dzięki temu łatwo możemy odczytać
# wartość k-tego największego elementu z danego przedziału. W kolejnych krokach dodajemy następne elementy z wejściowej tablic do 
# posortowanej tablicy pomocniczej utrzymując w niej porządek rosnoący, aby móc łatwo odczytywać k-ty największy element i dodać jego 
# wartość do porządanej sumy.   
