...
if __name__ == "__main__":
    ...
    graph19_edges_weights = [(0, 1, 2), (0, 2, 3), (0, 3, 7), (0, 4, 12), (1, 0, 2), (1, 2, 4), (1, 5, 2), (2, 0, 3), (2, 1, 4),
                            (2, 4, 2), (2, 5, 9), (2, 6, 5), (3, 0, 7), (3, 4, 5), (4, 0, 12), (4, 2, 2), (4, 3, 5), (4, 6, 3),
                            (5, 1, 2), (5, 2, 9), (5, 6, 1), (6, 2, 5), (6, 4, 3), (6, 5, 1)]

    print(f"MST (edges): {kruskal(graph19_edges_weights)}")
    ...
    print(f"MST (edges): {kruskal(graph20_edges_weights)}")